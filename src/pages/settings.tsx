...
import { CATEGORIES } from './settings/categories.ts';
import type { CategoryId } from './settings/categories.ts';
import { AppearanceSettings } from './settings/appearance.tsx';
import { HomeSettings } from './settings/home.tsx';
import { NavSettings } from './settings/nav.tsx';
import { DataSettings } from './settings/data.tsx';
import { LockSettings } from './settings/lock.tsx';
import { PortSettings } from './settings/port.tsx';
import { SwSettings } from './settings/sw.tsx';
import { ScambaitSettings } from './settings/scambait.tsx';
